...
>возможно, вам нужно будет авторизоваться на удалённом репозитории
...
![pull request](pullrequest.jpg)

9. Такой результат должен получиться после **compare and pull request**.
