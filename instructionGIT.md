...
Это может означать, что вы делали какую-то навигацию по истории коммитов, и неправильно вернулись к последнему коммиту. Для того чтобы исправить данную ошибку можно воспользоваться тремя способами:
